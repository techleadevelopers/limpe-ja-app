...
i18n
  ...
  .init({
    ...
    lng: Localization.getLocales()[0]?.languageCode || 'pt-BR', // Tenta 'en-US' como padrão se nada for detectado
    fallbackLng: 'pt-BR', // Idioma de fallback se a tradução não for encontrada
