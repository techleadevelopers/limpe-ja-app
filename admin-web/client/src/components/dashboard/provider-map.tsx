...
    // CORREÇÃO: Adiciona uma verificação para garantir que 'provider.name' exista.
    // Se 'provider.name' for undefined ou null, a string vazia '' é usada.
...
      <Sidebar />
      
      <div className="flex-1 ml-7 overflow-hidden">
        <Header 
...
              <Card className="shadow-floating border-0 h-full flex flex-col"> {/* AQUI */}
                <CardHeader>
...
                  </div>
                </CardHeader>
                <CardContent className="flex-1"> {/* AQUI */}
                  {isLoading ? (
                    <div className="h-full flex items-center justify-center"> {/* AQUI */}
                      <p className="text-gray-500">Carregando mapa...</p>
                    </div>
                  ) : isError ? (
                    <div className="h-full flex items-center justify-center text-red-600"> {/* AQUI */}
                      <p>Erro ao carregar mapa: {error?.message}</p>
                    </div>
                  ) : (
                    <div className="h-full bg-gradient-to-br from-blue-50 to-green-50 rounded-xl border border-blue-200 relative overflow-hidden"> {/* AQUI */}
                      {/* Map Background */}
