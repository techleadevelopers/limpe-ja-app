...
export default function ProviderMap() {
  ...
  const approvedProviders = filteredProviders.filter(p => p.verificationStatus === "APPROVED");
  const pendingProviders = filteredProviders.filter(p => 
    p.verificationStatus === "PENDING_MANUAL_REVIEW" || p.verificationStatus === "PENDING_DOCUMENTS_UPLOAD"
  );
  ...
  return (
    <div className="flex h-screen bg-admin-bg">
      ...
      <div className="flex-1 ml-72 overflow-hidden">
        <Header 
          title="Provider Map"
          subtitle="Geographic distribution of service providers across the platform."
        />
                ...
                <CardContent>
                  <div className="h-96 bg-gradient-to-br from-blue-50 to-green-50 rounded-xl border border-blue-200 relative overflow-hidden">
                    ...
                    {filteredProviders.map((provider, index) => {
                      ...
                      const x = 100 + (index * 50) % 250;
                      const y = 100 + (index * 30) % 150;
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={statusFilter} onValueChange={setStatusFilter}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="PENDING_DOCUMENTS_UPLOAD">Pending Documents</SelectItem>
