...
export const styles = StyleSheet.create({
    ...
    priceTextWhiteCard: {
        fontSize: 17, // Preço maior e mais proeminente
        fontWeight: '700',
        color: "rgb(56, 142, 235)", // Preço em destaque com a nova cor de destaque (vermelho/rosa)
        marginBottom: 10,
        left: 270,
    },
    ...
    infoChipsContainer: {
        ...
        bottom: 6,
        paddingHorizontal: 0, // Adicionado para alinhar com outras seções
    },
    infoChip: {
        flexDirection: 'row',
        alignItems: 'center',
        backgroundColor: COLOR_BACKGROUND, // Fundo do chip mais claro
        paddingVertical: 5, // Padding vertical um pouco maior
        paddingHorizontal: 10, // Padding horizontal um pouco maior
    ...
    tabContentContainer: {
        paddingHorizontal: 15, // Padding horizontal consistente para as seções
        paddingTop: 1,
        bottom: 30,
    },
    sectionTitle: {
    ...
    photoSectionHeader: {
        ...
        marginBottom: 10,
        bottom: 2, // Ajuste de margem para ficar logo abaixo da imagem principal
    },
    photoSectionTitle: {
        fontSize: 15,
        fontWeight: '700',
    ...
    thumbnailContainer: {
        width: 60, // Largura da thumbnail
        height: 60, // Altura da thumbnail
        left: 5, // Espaço à direita para o scroll horizontal
        borderRadius: 10, // Bordas arredondadas para as miniaturas
        overflow: 'hidden',
        marginBottom: 10,
        marginRight: 8, // Espaço entre as miniaturas
