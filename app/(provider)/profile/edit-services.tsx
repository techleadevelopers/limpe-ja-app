...
function useReducedMotion() {
  ...
  useEffect(() => {
    ...
    const subscription = AccessibilityInfo.addEventListener
      ...
      : // types fallback a algumas versões usam addEventListener('change', callback)
...
export default function EditProviderServicesScreen() {
  ...
  // Smart Step: Assistente de Servi�o
  ...
  // Fallback autom�tico: se o cat�logo vier vazio e n�o estiver carregando
  useEffect(() => {
