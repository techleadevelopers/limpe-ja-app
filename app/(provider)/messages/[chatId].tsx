...
export default function ProviderChatScreen() { // Renomeado para ProviderChatScreen
  ...
  // Mock para o status do pânico (copiado do cliente)
  ...
  }, [isAuthenticated, token, chatId, userId, bookingId, inputContainerAnim]); // Adicionar inputContainerAnim como dependência
  ...
  // Handler para o botão de pânico (copiado do cliente)
